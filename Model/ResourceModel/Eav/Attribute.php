...
namespace EcommPro\CustomCurrency\Model\ResourceModel\Eav;

use EcommPro\CustomCurrency\Setup\CurrencySetup;
...
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'EcommPro_Currency';
     ...
     * @var string
     */
    protected $_eventPrefix = CurrencySetup::ENTITY_TYPE_CODE . '_entity_attribute';
    ...
    {
        $this->_init('EcommPro\CustomCurrency\Model\ResourceModel\Attribute');
    }
